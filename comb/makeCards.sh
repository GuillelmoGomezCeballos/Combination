...
echo "CMS_ssww_wwttnorm  rateParam SSWW_2016 Signal1 1 [0.1,3]" >> ssww_2019_fiducial5.text
echo "CMS_ssww_wwttnorm  rateParam SSWW_2017 Signal1 1 [0.1,3]" >> ssww_2019_fiducial5.text
echo "CMS_ssww_wwttnorm  rateParam SSWW_2018 Signal1 1 [0.1,3]" >> ssww_2019_fiducial5.text
echo "CMS_ssww_wwttnorm  rateParam SSWW_2016 Signal2 1 [0.1,3]" >> ssww_2019_fiducial5.text
echo "CMS_ssww_wwttnorm  rateParam SSWW_2017 Signal2 1 [0.1,3]" >> ssww_2019_fiducial5.text
echo "CMS_ssww_wwttnorm  rateParam SSWW_2018 Signal2 1 [0.1,3]" >> ssww_2019_fiducial5.text
echo "CMS_ssww_wznorm  rateParam SSWW_2016 WZ 1 [0.1,3]" >> ssww_2019_fiducial5.text
echo "CMS_ssww_wznorm  rateParam SSWW_2017 WZ 1 [0.1,3]" >> ssww_2019_fiducial5.text
echo "CMS_ssww_wznorm  rateParam SSWW_2018 WZ 1 [0.1,3]" >> ssww_2019_fiducial5.text
echo "CMS_ssww_wznorm  rateParam SSWW_2016 EWKWZ 1 [0.1,3]" >> ssww_2019_fiducial5.text
echo "CMS_ssww_wznorm  rateParam SSWW_2017 EWKWZ 1 [0.1,3]" >> ssww_2019_fiducial5.text
echo "CMS_ssww_wznorm  rateParam SSWW_2018 EWKWZ 1 [0.1,3]" >> ssww_2019_fiducial5.text
...
ssww_2019_fiducial5.text -o workspace_ssww_2019_fiducial5_rs0only.root;
  ...
  if [ $# == 2 ] && [ $2 == 'comb' ]; then
    ...
    echo "CMS_ssww_wwttnorm  rateParam SSWW_2019 Signal2 1 [0.1,3]" >> ssww_comb_fiducial5.text
    echo "CMS_ssww_wznorm  rateParam SSWW_2019 WZ 1 [0.1,3]" >> ssww_comb_fiducial5.text
    echo "CMS_ssww_wznorm  rateParam SSWW_2019 EWKWZ 1 [0.1,3]" >> ssww_comb_fiducial5.text
